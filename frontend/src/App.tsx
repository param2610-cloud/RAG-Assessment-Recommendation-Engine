      ...
      <main className="flex-grow">
        <div className="bg-[#f6f6f6] py-8 border-b border-gray-200">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h1 className="text-3xl font-bold text-blue-600">Smart Assessment Recommendation System</h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mt-12 mb-8">
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
              <h2 className="text-lg font-semibold text-blue-600 mb-4">Why Choose Our Assessment System?</h2>
